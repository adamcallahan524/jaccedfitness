        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            ...
            <div className="flex space-x-4">
              <a href="#" className="text-gray-400 hover:text-fitness-primary">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/privacy" className="text-gray-600 hover:text-fitness-primary">Privacy Policy</Link></li>
              <li><Link to="/terms" className="text-gray-600 hover:text-fitness-primary">Terms of Service</Link></li>
              <li><Link to="/cookies" className="text-gray-600 hover:text-fitness-primary">Cookie Policy</Link></li>
            </ul>
          </div>
        </div>
